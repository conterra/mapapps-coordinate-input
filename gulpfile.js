...
gulp.task("run-tests",
    gulp.series(
        ...
        function transportTestUrls() {
            ...
            const testsAt = mapappsBrowserSync.state.url + "/resources/jsregistry/root/@conterra/mapapps-mocha-runner/latest/mocha.html?boot=/js/tests/test-init.js&timeout=5000&test=dn_coordinate_input/tests/all&reporter=tap";
